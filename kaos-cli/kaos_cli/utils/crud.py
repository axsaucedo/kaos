...
def list_resources(resource_type: ResourceType, namespace: str | None, output: str) -> None:
...
def get_resource(resource_type: ResourceType, name: str, namespace: str, output: str) -> None:
...
def logs_resource(resource_type: ResourceType, name: str, namespace: str, follow: bool, tail: int | None) -> None:
...
def delete_resource(resource_type: ResourceType, name: str, namespace: str, force: bool) -> None:
    """Delete a resource."""
    display_name = resource_type.capitalize()
    if not force:
        confirm = typer.confirm(f"Delete {display_name} '{name}' in namespace '{namespace}'?")
        if not confirm:
