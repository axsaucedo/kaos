...
const mcpServerFinalizerName = "kaos.dev/mcpserver-finalizer"
...
//+kubebuilder:rbac:groups=kaos.dev,resources=mcpservers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=kaos.dev,resources=mcpservers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=kaos.dev,resources=mcpservers/finalizers,verbs=update
