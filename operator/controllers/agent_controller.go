...
const agentFinalizerName = "kaos.dev/agent-finalizer"
...
//+kubebuilder:rbac:groups=kaos.dev,resources=agents,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=kaos.dev,resources=agents/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=kaos.dev,resources=agents/finalizers,verbs=update
//+kubebuilder:rbac:groups=kaos.dev,resources=modelapis,verbs=get;list;watch
//+kubebuilder:rbac:groups=kaos.dev,resources=mcpservers,verbs=get;list;watch
