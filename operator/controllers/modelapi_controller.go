...
const modelAPIFinalizerName = "kaos.dev/modelapi-finalizer"
...
//+kubebuilder:rbac:groups=kaos.dev,resources=modelapis,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=kaos.dev,resources=modelapis/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=kaos.dev,resources=modelapis/finalizers,verbs=update
