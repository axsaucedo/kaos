...
type AgentConfig struct {
	...
	// ToolCallMode controls how the agent invokes tools and sub-agents.
	// - auto (default): tries native tool calling first, falls back to string-based if unsupported
