...
func (in *AgentConfig) DeepCopyInto(out *AgentConfig) {
	*out = *in
	...
	if in.TaskMaxIterations != nil {
		in, out := &in.TaskMaxIterations, &out.TaskMaxIterations
		*out = new(int32)
		**out = **in
	}
	if in.TaskMaxRuntimeSeconds != nil {
		in, out := &in.TaskMaxRuntimeSeconds, &out.TaskMaxRuntimeSeconds
		*out = new(int32)
		**out = **in
	}
	if in.TaskMaxToolCalls != nil {
		in, out := &in.TaskMaxToolCalls, &out.TaskMaxToolCalls
		*out = new(int32)
		**out = **in
	}
}
